        ...
        <Stack component="form" spacing={3} onSubmit={submit}>
          ...
          <Grid container spacing={2.5}>
            <Grid size={{ xs: 12, md: 8 }}>
              <Stack spacing={1}>
                <TextField required fullWidth multiline minRows={4} label="Falla reportada por el cliente" placeholder="Describe el problema tal como lo explica el cliente..." value={form.issue} onChange={update('issue')} />
