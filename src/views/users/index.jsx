  ...
  return (
    <Stack spacing={3}>
      <Stack direction={{ xs: 'column', sm: 'row' }} sx={{ alignItems: { sm: 'center' }, justifyContent: 'space-between', gap: 2 }}>
        <Box>
          <Typography variant="h2">Usuarios y roles</Typography>
          <Typography color="text.secondary" sx={{ mt: 0.5 }}>
            Administra el equipo que opera el taller.
          </Typography>
        </Box>
      ...
      <MainCard title="Usuarios activos">
        <Stack spacing={1.5}>
          {users.map((user) => (
            <Stack
              direction="row"
            ...
            >
              ...
              <Chip
                ...
                icon={user.role === 'ADMIN' ? <AdminPanelSettingsRoundedIcon /> : undefined}
              />
          ...
          <DialogContent>
            <Stack spacing={2} sx={{ pt: 1 }}>
              ...
              >
                ...
                <MenuItem value="RECEPTIONIST">Recepción</MenuItem>
              </TextField>
            </Stack>
          </DialogContent>
          <DialogActions>
