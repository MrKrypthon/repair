...
export default function Inventory() {
  ...
  return (
    <Stack spacing={3}>
      <Stack direction={{ xs: 'column', sm: 'row' }} sx={{ alignItems: { sm: 'center' }, justifyContent: 'space-between', gap: 2 }}><Box><Typography variant="h2">Inventario</Typography><Typography color="text.secondary" sx={{ mt: 0.5 }}>Piezas, componentes y consumibles del taller.</Typography></Box><Button variant="contained" startIcon={<AddRoundedIcon />} onClick={() => setNewItemOpen(true)}>Nueva pieza</Button></Stack>
