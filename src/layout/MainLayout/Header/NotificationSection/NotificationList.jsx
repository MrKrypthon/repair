      ...
      {notifications.map((notification) => (
        <ListItemButton
          ...
          sx={{
            ...
            borderLeftColor: `${typeColor[notification.type] || 'primary'}.main`,
            p: 2
          }}
        >
          ...
          <Stack direction="row" spacing={1} sx={{ mt: 1 }}>
            <Chip
              label={notification.read ? 'Leída' : 'Nueva'}
              size="small"
              color={notification.read ? 'default' : typeColor[notification.type] || 'warning'}
            />
            <Box component="span" sx={{ color: 'text.secondary', fontSize: '0.75rem', alignSelf: 'center' }}>
